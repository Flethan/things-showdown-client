...
export class BattleScene implements BattleSceneStub {
	...
	resetStatbar(pokemon: Pokemon, startHidden?: boolean) {
		return pokemon.sprite.updateStatbar(pokemon, startHidden);
	}
...
export class PokemonSprite extends Sprite {
	...
	getStatbarHTML(pokemon: Pokemon) {
		...
		else if (pokemon.getSpecies().forme === 'Element') symbol = 'element';
		else if (pokemon.getSpecies().forme === 'Null') symbol = 'null';
		else if (pokemon.getSpecies().forme === 'Mu') symbol = 'mu';
